            ...
            <div class="p-6 border-b border-gray-100 dark:border-gray-800" x-data="{
                ...
                <div class="flex flex-wrap gap-2 mt-4">
                    ...
                    <button @click="$store.tradeFilter.value = 'LOSE'"
                            :class="$store.tradeFilter.value === 'LOSE' ? 'bg-gray-600 text-white' : 'bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-400'"
                            class="px-3 py-2 rounded-lg text-sm font-medium transition-colors">
                        Closed
                    </button>
                    <button @click="$store.tradeFilter.value = 'Buy'"
                            :class="$store.tradeFilter.value === 'Buy' ? 'bg-primary text-white' : 'bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-400'"
                            class="px-3 py-2 rounded-lg text-sm font-medium transition-colors">
                        Deposits
                    </button>
                ...
                <div class="space-y-3">
                    @if(isset($t_history) && $t_history->count() > 0)
                        @foreach($t_history as $history)
                            <div class="activity-item bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-100 dark:border-gray-700"
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                                    @if($history->type == 'LOSE') bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400
                                                    ...
                                                    @if($history->type == 'WIN') Credited
                                                    @elseif($history->type == 'LOSE') Closed
                                                    @elseif($history->type == 'Buy') Deposit
                                                    @elseif($history->type == 'Sell') Withdrawal
                                                    @else {{ $history->type }} @endif
                                                </span>
                                            </div>
                    ...
                    @else
                        ...
                        <div class="text-center py-12">
                            ...
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-1">No transaction history</h3>
                            <p class="text-gray-600 dark:text-gray-400 text-sm mb-4">
                                Your investment activity will appear here
                            </p>
                            <a href="{{ route('dashboard') }}"
                               class="inline-flex items-center gap-2 px-4 py-2 bg-primary hover:opacity-90 text-white rounded-lg text-sm font-medium transition-colors">
