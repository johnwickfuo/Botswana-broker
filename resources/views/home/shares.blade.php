    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="max-w-3xl">
            ...
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
                Hold a Stake in Botswana's National Assets
            </h1>
            <p class="text-lg text-gray-600 leading-relaxed mb-8">
                {{ $settings->site_name }} allows citizens and institutions to invest in verified government assets across the nation's key sectors. Earn regulated, transparent returns paid in Pula while supporting national growth.
            </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="p-6 rounded-xl border border-gray-200">
                ...
                <p class="text-gray-600">Each investment is tied to recognised government assets in mining, energy, infrastructure, water and agriculture.</p>
            </div>
            <div class="p-6 rounded-xl border border-gray-200">
                <div class="w-12 h-12 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mb-4">
            ...
            <div class="p-6 rounded-xl border border-gray-200">
                ...
                <p class="text-gray-600">Terms and expected returns are stated clearly before you commit, with payments settled in Pula.</p>
            </div>
        </div>
    </div>
</section>
