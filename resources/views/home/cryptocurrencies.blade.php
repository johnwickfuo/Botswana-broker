...
@section('title', 'Water & Agriculture Investments')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="p-6 rounded-xl border border-gray-200">
                ...
                <p class="text-gray-600">Investments are tied to recognised government holdings in water and agriculture, held to transparent public standards.</p>
            </div>
            <div class="p-6 rounded-xl border border-gray-200">
                <div class="w-12 h-12 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mb-4">
